# Create HDInsight Linux cluster and run custom script action to install Apache Spark 1.6.0
Creates HDInsight Linux cluster and run custom script action to install Apache Spark 1.6.0<br>
...
This template creates an HDInsight Linux based cluster and then updates the cluster headnodes with the Apache Spark 1.6.0 binaries(including YARN support).<br>
